...
class Corpus:
    ...
    def get_validation_pred(self, args, model, unique_entities):
        ...
        for iters in range(1):
            ...
            print("test set length ", len(self.validation_indices))
        ...
        print("\nValidation: Cumulative stats are -> ")
        ...
        return (cumulative_mean_rank, cumulative_mean_recip_rank, cumulative_hits_one, cumulative_hits_three, cumulative_hits_ten) # return (MR, MRR, H1, H3, H10)


    def get_testing_pred(self, args, model, unique_entities):
        average_hits_at_100_head, average_hits_at_100_tail = [], []
        average_hits_at_ten_head, average_hits_at_ten_tail = [], []
        average_hits_at_three_head, average_hits_at_three_tail = [], []
        average_hits_at_one_head, average_hits_at_one_tail = [], []
